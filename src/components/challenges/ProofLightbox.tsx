  ...
  const modal = (
    ...
    >
      ...
      >
        ...
        <div className="flex min-h-[200px] items-center justify-center px-4 py-4 sm:px-6">
          {loading && (
        ...
        <div className="border-t border-[var(--card-border)] px-4 py-4 sm:px-6 sm:py-4">
          <div className="flex flex-wrap items-center gap-3 gap-y-2 text-sm">
            ...
            {verifiedAt && (
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="text-[var(--text-dark)]">{formatReviewedDate(verifiedAt)}</span>
              </div>
            )}
          </div>
          {showXp && (
          ...
          {rejected && aiReason && (
            <div className="mt-4 rounded-lg border border-orange-200 bg-orange-50 px-3 py-2 text-xs font-medium leading-snug text-orange-950">
              <span className="font-bold text-orange-800">Reason:</span> {aiReason}
            </div>
          )}
        </div>
      </div>
