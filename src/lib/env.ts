...
type EnvKey =
  ...
  | "NEXT_API_KEY"
  | "NEXT_PUBLIC_IB_USER_ACCOUNTS_BASE_URL"
  | "NEXT_PUBLIC_NW_APPLICATION_BASE_URL"
  | "NEXT_PUBLIC_CLIENT_KEY_DETAILS_ID"
  | "NEXT_PUBLIC_NIAT_APPLICATION_NAME_ENUM"
  | "NEXT_PUBLIC_NIAT_SECTION_ENTITY_CONFIG_ID";
...
function getEnv(): Record<EnvKey | OptionalEnvKey, string> {
  ...
  return {
    ...
    NEXT_PUBLIC_IB_USER_ACCOUNTS_BASE_URL:
      process.env.NEXT_PUBLIC_IB_USER_ACCOUNTS_BASE_URL!,
    NEXT_PUBLIC_NW_APPLICATION_BASE_URL:
      process.env.NEXT_PUBLIC_NW_APPLICATION_BASE_URL!,
    NEXT_PUBLIC_CLIENT_KEY_DETAILS_ID:
      process.env.NEXT_PUBLIC_CLIENT_KEY_DETAILS_ID!,
    NEXT_PUBLIC_NIAT_APPLICATION_NAME_ENUM:
      process.env.NEXT_PUBLIC_NIAT_APPLICATION_NAME_ENUM!,
    NEXT_PUBLIC_NIAT_SECTION_ENTITY_CONFIG_ID:
      process.env.NEXT_PUBLIC_NIAT_SECTION_ENTITY_CONFIG_ID!,
  };
}
